...
import { OurServicesCarousel } from "./constants/OurServicesCarousel";
...
import { whatPeopleSays } from "./constants/WhatPeopleSays";
import { Separator } from "@/components/ui/separator";
import { OurFleetData } from "./constants/OurFleetData";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      ...
      <div className="bg-gray1 lg:-mt-20 lg:rounded-t-xl flex flex-col items-center w-full lg:w-[80%] p-6 lg:pt-3 lg:pr-28 lg:pl-28 lg:pb-28">
        ...
        >
          <CarouselContent>
            {OurServicesCarousel.map((service, index) => (
              <CarouselItem
                key={index}
      ...
      <div className="min-h-screen w-full bg-gradient-to-r from-gray4 to-black flex flex-col items-center justify-center py-16 lg:py-32">
        <div className="flex flex-col lg:flex-row w-[90%] lg:w-[80%] justify-between items-center lg:items-end mb-10 lg:mb-14">
          ...
          <Image
            ...
            priority
            unoptimized
            className="h-[500px] rounded-3xl w-full lg:w-auto object-cover"
            src={ManInACar}
            alt="man in a car"
          />
        </div>
      ...
      <div className="w-[90%] lg:w-[80%] flex flex-col justify-center items-center h-auto py-32">
          ...
          {OurFleetData.map((car, index) => (
            ...
            >
              <Image
                ...
                alt={car.carName}
              />
              <span className="text-gray2 font-bold mt-2">{car.carName}</span>
              <span className="text-gray2">{car.carClass}</span>
        ...
        <div className="w-full flex justify-center items-center">
          <Link
            href={"/pages/OurServices/OurFleet"}
