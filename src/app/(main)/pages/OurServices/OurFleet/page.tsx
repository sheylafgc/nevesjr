"use client";
import { OurFleetData } from "@/app/constants/OurFleetData";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  ...
  return (
    <div className="flex justify-center items-center w-full flex-col">
      ...
      <div className="w-[80%] flex flex-col justify-center items-center gap-5 pt-16 pb-20">
        {OurFleetData.map((service, index) => (
          <div
            key={index}
          ...
          >
            ...
            <div className="w-full lg:hidden flex flex-col justify-between items-center my-5">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="overview">
                  ...
                  <AccordionContent>{service.overview}</AccordionContent>
                </AccordionItem>
                <AccordionItem value="amenities">
                  <AccordionTrigger>Amenities</AccordionTrigger>
                  <AccordionContent>{service.amenities}</AccordionContent>
                </AccordionItem>
                <AccordionItem value="bestForTheseServices">
                  <AccordionTrigger>Best for these service</AccordionTrigger>
                  <AccordionContent>
                    {service.bestForTheseService}
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
            ...
            <div className=" flex-col pb-10 hidden lg:flex">
              <h1 className="text-2xl font-bold mb-1">{service.carName}</h1>
              <Tabs defaultValue="overview" className="w-[600px]">
                ...
                <TabsContent value="amenities">{service.amenities}</TabsContent>
